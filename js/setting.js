...
OpenSpending.identifier = 'spending_amakusashi_2013';
...
OpenSpending.Styles.Cofog = {
  ...
  '3-1': { icon: 'icons/economy-tourism.svg', color: '#C75746', bcolor: '#4E6D00' },
  '4': { icon: 'icons/our-streets.svg', color: '#C75746', bcolor: '#D33673' },
  '4-1': { icon: 'icons/our-streets.svg', color: '#C75746', bcolor: '#D33673' },
  '5': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#2A3A03' },
  '5-1': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#2A3A03' },
  ...
  '8-1': { icon: 'icons/government.svg', color: '#C75746', bcolor: '#C75746' },
